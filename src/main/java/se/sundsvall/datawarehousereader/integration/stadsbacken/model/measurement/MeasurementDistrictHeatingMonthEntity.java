...
public class MeasurementDistrictHeatingMonthEntity implements DefaultMeasurementAttributesInterface {
	...
	@Column(name = "FeedTypeID", nullable = false, insertable = false, updatable = false, columnDefinition = "tinyint")
	...
	public MeasurementDistrictHeatingMonthEntity withFeedTypeId(Integer feedTypeId) {
		this.feedTypeId = feedTypeId;
		return this;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(customerOrgId, facilityId, feedType, feedTypeId, interpolation, measurementTimestamp,
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(customerOrgId, other.customerOrgId) && Objects.equals(facilityId, other.facilityId)
				&& Objects.equals(feedType, other.feedType) && Objects.equals(feedTypeId, other.feedTypeId)
	...
	public String toString() {
		...
		builder.append("MeasurementDistrictHeatingMonthEntity [customerOrgId=").append(customerOrgId).append(", uuid=")
				...
				.append(", feedTypeId=").append(feedTypeId).append(", interpolation=").append(interpolation)
				.append(", measurementTimestamp=").append(measurementTimestamp).append(", unit=").append(unit)
				.append(", usage=").append(usage).append(", readingSequence=").append(readingSequence).append("]");
